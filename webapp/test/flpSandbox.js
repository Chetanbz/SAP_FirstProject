		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "demoUI5",
									"targetURL": "#SAPUI5sapdemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"SAPUI5sapdemo-display": {
								"semanticObject": "SAPUI5sapdemo",
								"action": "display",
								"description": "com.demo.ui5",
								"title": "demoUI5",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=SAPUI5.sapdemo",
									"url": sap.ui.require.toUrl("SAPUI5/sapdemo")
								}
							}
						}
					}
